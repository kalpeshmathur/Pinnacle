 ...
 */
public class QuantitativeAptitudeHindiVideos extends Fragment {
    ...
    public QuantitativeAptitudeHindiVideos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_quantitative_aptitude_hindi_videos, container, false);
