 ...
 */
public class VerbalReasoningHindiVideos extends Fragment {
    ...
    public VerbalReasoningHindiVideos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_verbal_reasoning_hindi_videos, container, false);
