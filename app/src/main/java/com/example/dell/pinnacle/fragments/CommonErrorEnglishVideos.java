 ...
 */
public class CommonErrorEnglishVideos extends Fragment {
    ...
    public CommonErrorEnglishVideos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_common_error_english_videos, container, false);

        subject_name = "common Error";
        language = "english";
        type = "video";
        days = "0";
