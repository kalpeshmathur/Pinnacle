 ...
 */
public class VerbalReasoningEnglishVideo extends Fragment {
    ...
    public VerbalReasoningEnglishVideo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_verbal_reasoning_english_video, container, false);
        subject_name = "VerbalReasoning";
        language = "english";
        type = "video";
        days = "0";
