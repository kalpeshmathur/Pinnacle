 ...
 */
public class JobAssureEnglishVideos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_job_assure_english_videos, container, false);
        t= JobAssure.tier;
        if (t.equals("three")){
