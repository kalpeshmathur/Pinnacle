...
public class SpotTheErrorEnglishVideos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_spot_the_error_english_videos, container, false);
        subject_name = "spot the error";
        language = "english";
        type = "video";
        days = "0";
