 ...
 */
public class ClozeTestEnglishVideos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_cloze_test_english_videos, container, false);

        subject_name = "cloze test";
        language = "english";
        type = "video";
        days = "0";
