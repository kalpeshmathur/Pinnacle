 ...
 */
public class ActivePassiveVoiceHindiVideos extends Fragment {
    ...
    public ActivePassiveVoiceHindiVideos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_active_passive_voice_hindi_videos, container, false);
