 ...
 */
public class NarrationEnglishVideos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_narration_english_videos, container, false);
        subject_name = "Narration";
        language = "english";
        type = "video";
        days = "0";
