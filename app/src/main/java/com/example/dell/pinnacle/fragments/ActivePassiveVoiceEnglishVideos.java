 ...
 */
public class ActivePassiveVoiceEnglishVideos extends Fragment {
    ...
    public ActivePassiveVoiceEnglishVideos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_active_passive_voice_english_videos, container, false);

        subject_name = "Active passive Voice";
        language = "english";
        type = "video";
        days = "0";
