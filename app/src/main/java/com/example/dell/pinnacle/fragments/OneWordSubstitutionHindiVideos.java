 ...
 */
public class OneWordSubstitutionHindiVideos extends Fragment {
    ...
    public OneWordSubstitutionHindiVideos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_one_word_substitution_hindi_videos, container, false);
