 ...
 */
public class SpotTheErrorHindiVideos extends Fragment {
    ...
    public SpotTheErrorHindiVideos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_spot_the_error_hindi_videos, container, false);
