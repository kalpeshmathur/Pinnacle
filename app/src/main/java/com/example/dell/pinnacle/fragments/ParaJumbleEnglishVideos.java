...
public class ParaJumbleEnglishVideos extends Fragment {
    ...
    public ParaJumbleEnglishVideos() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_para_jumble_english_videos, container, false);

        subject_name = "para jumble";
        language = "english";
        type = "video";
        days = "0";
