 ...
 */
public class GeneralStudiesEnglishVideos extends Fragment {
    ...
    public GeneralStudiesEnglishVideos() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_general_studies_english_videos, container, false);
